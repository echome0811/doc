...
try
  ...
  begin
    ...
    begin
      ...
      if DocDataMgr_1.DocList.Count>0 Then
      begin
        ShowMsgTw('∞ı¶ÊßÂ∂q¿¿µo§Ωßi¶€∞ ºfÆ÷,º∆∂q:'+IntToStr(DocDataMgr_1.DocList.Count));
        for i:=DocDataMgr_1.DocList.Count-1 downto 0 do
        begin
          ADoc2:=DocDataMgr_1.DocList.Items[i];
          ShowMsg(FAppParam.TwConvertStr('¶€∞ ºfÆ÷¿¿µo§Ωßi ')+ADoc2.Title,false);
      ...
      if DocDataMgr_3.DocList.Count>0 Then
      begin
        ShowMsgTw('∞ı¶ÊßÂ∂qπL∑|§Ωßi¶€∞ ºfÆ÷,º∆∂q:'+IntToStr(DocDataMgr_3.DocList.Count));
        for i:=DocDataMgr_3.DocList.Count-1 downto 0 do
        begin
          ADoc2:=DocDataMgr_3.DocList.Items[i];
          ShowMsg(FAppParam.TwConvertStr('¶€∞ ºfÆ÷πL∑|§Ωßi ')+ADoc2.Title,false);
