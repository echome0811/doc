unit uParseYuanTaHtm;

interface
  uses Classes,TParseYuanTaHtm,TParseHtmTypes;
...
begin
  result:=false;
try
  FParse := TParseYuanTaHtmMgr.Create(IniFileName);
  result:=true;
except
end;
end;
...
initialization
    //FParse := TParseYuanTaHtmMgr.Create;
finalization
