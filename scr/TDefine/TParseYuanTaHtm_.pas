...
constructor TParseYuanTaHtmMgr.Create;
begin
   FLastErrMsg:='';
end;
Function TParseYuanTaHtmMgr._GetHtmlAddress(ID:PChar;CurrPage:integer):ShortString;
begin
  Result:='http://justdata.yuanta.com.tw/Z/ZC/ZCV/ZCV_'+StrPas(ID)
  ...
  Try
    ...
    begin
      ...
      begin
        ...
        //Address
        FTitleLst[j].Address:='http://justdata.yuanta.com.tw'
